...
export default {
  head() {
    return {
      title: 'NBL Mini',
      meta: [
        { name: 'description', content: 'This is the home page for the NBL Mini website.' },
        { name: 'keywords', content: 'about NBL, NBL home page, National Basketball League, basketball' },
      ]
    }
  }
}
